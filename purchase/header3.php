  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <!--   Company -->
          <li class="nav-item has-treeview ">
            <a href="company.php" class="nav-link "  id="product">
          ...
          <li class="nav-item has-treeview active">
            <a href="../purchase/view_purchase.php" class="nav-link active"  id="product">
          ...
          <!--   Sale -->
          <li class="nav-item has-treeview">
            <a href="../sale/view_sale.php" class="nav-link"  id="product">
