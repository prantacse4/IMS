  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <!--   Company -->
          <li class="nav-item has-treeview <?php if($page=='company'){echo '-menuopen menu-open active';} ?>">
            <a href="company.php" class="nav-link <?php if($page=='company'){echo 'active';} ?>"  id="product">
